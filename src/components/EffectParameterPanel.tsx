      ...
      {effects.map((effect) => (
        ...
        >
          ...
          <div className="flex items-center gap-2 p-3">
            <button
              onClick={() => toggleEffect(effect.effectId, !effect.enabled)}
            ...
            <button
              onClick={() =>
                setExpandedEffectId(
                  expandedEffectId === effect.effectId ? null : effect.effectId
                )
              }
              className="p-1 rounded hover:bg-gray-700"
            >
              {expandedEffectId === effect.effectId ? (
            ...
            <div className="border-t border-gray-700 p-3 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  value={effect.wetDry}
                  onChange={(e) =>
                    handleWetDryChange(effect.effectId, parseFloat(e.target.value))
                  }
                  className="w-full"
                />
              </div>
              ...
              {Object.entries(effect.parameters).map(([paramName, paramValue]) => (
                <EffectParameter
                  ...
                  onChange={(value) => handleParameterChange(effect.effectId, paramName, value)}
                />
              ))}
