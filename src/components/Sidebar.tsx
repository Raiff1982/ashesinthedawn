              ...
              <div className="flex-1 overflow-y-auto p-4">
                ...
                {activeTab === 'ai' && (
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <button className="w-full p-2 bg-blue-600 hover:bg-blue-700 rounded text-xs text-white" onClick={handleSmartGainStaging}>
                        Smart Gain Staging
                      </button>
                      <button className="w-full p-2 bg-blue-600 hover:bg-blue-700 rounded text-xs text-white" onClick={handleRoutingAssistant}>
                        Routing Assistant
                      </button>
                      <button className="w-full p-2 bg-blue-600 hover:bg-blue-700 rounded text-xs text-white">
